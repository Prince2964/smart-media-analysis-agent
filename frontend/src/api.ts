...
export type Job = {phase?:string;timings?:Record<string,number>;id:string;source_type:Kind;source_name:string;status:'queued'|'processing'|'complete'|'failed';stage:number;error:string|null;document:MediaDocument|null};
